...
use App\Nova\CalendarEventGenerators\OffDayEventGenerator;
use Wdelfuego\NovaCalendar\DataProvider\AbstractCalendarDataProvider;
use Wdelfuego\NovaCalendar\Event;
use App\Nova\User;

class CalendarAvailabilityDataProvider extends AbstractCalendarDataProvider
{
    //
    ...
    public function novaResources() : array
    {
        return [
            ...
            \App\Nova\UserOffDay::class => new OffDayEventGenerator(),
